            ...
            >
                ...
                <div className="p-8 sm:p-10">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-blue-200 text-sm">Sign up to join EduManage</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-center">
                            ...
                            <label htmlFor="terms" className="ml-2 block text-sm text-blue-100">
                                I agree to the <a href="#" className="font-medium text-blue-300 hover:text-blue-100 transition-colors">Terms of Service</a> and <a href="#" className="font-medium text-blue-300 hover:text-blue-100 transition-colors">Privacy Policy</a>
                            </label>
                        </div>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-blue-200">
                            ...
                            <Link href="/auth/signin" className="font-medium text-blue-300 hover:text-blue-100 transition-colors">
                                Sign In
                            </Link>
                        </p>
                    </div>
